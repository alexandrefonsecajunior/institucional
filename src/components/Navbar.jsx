...
import TMVLogoRays from './effects/TMVLogoRays'
    ...
    <nav className="navbar fixed top-0 w-full bg-dark-bg/95 backdrop-blur-sm z-50 py-4 transition-all duration-300 border-b border-border-color/20">
      <div className="max-w-7xl mx-auto px-8 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <TMVLogoRays size={70} className="text-accent" />
        </div>
      ...
      <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'} bg-dark-bg border-t border-border-color/30`}>
        <ul className="flex flex-col py-6 px-6 space-y-1">
          <li><a href="#home" className="text-text-gray hover:text-accent transition-colors duration-300 px-4 py-3 block text-sm hover:bg-accent/5 border border-transparent hover:border-accent/30">{t('nav.home')}</a></li>
          <li><a href="#company" className="text-text-gray hover:text-accent transition-colors duration-300 px-4 py-3 block text-sm hover:bg-accent/5 border border-transparent hover:border-accent/30">{t('nav.company')}</a></li>
          <li><a href="#about" className="text-text-gray hover:text-accent transition-colors duration-300 px-4 py-3 block text-sm hover:bg-accent/5 border border-transparent hover:border-accent/30">{t('nav.about')}</a></li>
          <li><a href="#skills" className="text-text-gray hover:text-accent transition-colors duration-300 px-4 py-3 block text-sm hover:bg-accent/5 border border-transparent hover:border-accent/30">{t('nav.skills')}</a></li>
          <li><a href="#projects" className="text-text-gray hover:text-accent transition-colors duration-300 px-4 py-3 block text-sm hover:bg-accent/5 border border-transparent hover:border-accent/30">{t('nav.projects')}</a></li>
          <li><a href="#contact" className="text-text-gray hover:text-accent transition-colors duration-300 px-4 py-3 block text-sm hover:bg-accent/5 border border-transparent hover:border-accent/30">{t('nav.contact')}</a></li>
        </ul>

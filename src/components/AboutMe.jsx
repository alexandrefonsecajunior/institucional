...
const AboutMe = () => {
  ...
  return (
    <section id="about" className="py-16 sm:py-20 lg:py-24 bg-darker-bg relative overflow-hidden">
      {/* SVG decorativo no fundo */}
      <div className="hidden sm:block absolute top-16 right-8 opacity-5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8 mt-10 sm:mt-12">
